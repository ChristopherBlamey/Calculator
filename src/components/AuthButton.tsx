...
export function AuthButton() {
  ...
  if (loading) {
    return (
      <button disabled className="flex items-center gap-2 px-4 py-2 bg-white/10 text-white/40 rounded-xl">
  ...
  if (!user) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-wanda-pink text-white font-bold rounded-xl hover:bg-wanda-pink-light transition-colors"
      >
